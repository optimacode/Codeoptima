...
while True:
    ...
    if secim == "1":
        ...
        ws.append([ad, soyad, r10_kullanici_adi, miktar, maliyet, alinan_tutar, kazanc, tarih, hesap_durumu,proxy_maliyeti,proxy_adet,cevir,sms,sms_maliyet,sms_cevir])
    ...
    # Verileri güncelleme
        ...
        r10_kullanici_adi = input("Güncellemek istediğiniz hesabın R10 kullanıcı adını girin: ")
        ...
        for row in ws.iter_rows(min_row=2, values_only=True):
            if row[2] == r10_kullanici_adi:
                ...
                # Update the row
                row = [row[0], row[1], row[2], miktar, maliyet, alinan_tutar, kazanc, tarih, hesap_durumu,proxy_maliyeti,proxy_adet,cevir,sms,sms_maliyet,sms_cevir]
                ws.append(row)
